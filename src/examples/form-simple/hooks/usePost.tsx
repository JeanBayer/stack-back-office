import { PostService } from '@form-simple/services';
import { useStore } from '@form-simple/store';
import { Post, PostResponse } from '@form-simple/types';
import { Constants, ErrorUtil, QueryClientUtil } from '@form-simple/utils';
import {
  keepPreviousData,
  useMutation,
  useQuery,
